...
if sys.platform=="win32" or sys.platform=="cygwin":
    ...
    #
    libnames   = ["alglib406_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"]
    targetname =  "alglib406_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"
    dirname    = "bin-windows-intel"
else:
    libnames   = ["alglib406_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"]
    targetname = "alglib406_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"
