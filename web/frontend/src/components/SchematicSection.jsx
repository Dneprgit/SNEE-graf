...
const SchematicSection = ({ calculationResult, parameters }) => {
  ...
  return (
    <section id="schematic" className="section-container bg-gradient-to-br from-green-50 to-emerald-50">
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h2 className="section-title text-center">Схема системы СНЭЭ</h2>
        ...
        >
          ...
          >
            <defs>
              ...
              <linearGradient id="inverterGradient" x1="0%" y1="0%" x2="100%" y2="0%">
