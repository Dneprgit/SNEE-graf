...
docker build -f Dockerfile.backend.prod -t end2040/snee_web_spes-backend:1.536 .
# latest .

#3 Собираем Frontend образ
docker build -f Dockerfile.frontend.prod -t end2040/snee_web_spes-frontend:1.536 .
# latest .
...
# Push Backend
docker push end2040/snee_web_spes-backend:1.536
# latest
# Push Frontend
docker push end2040/snee_web_spes-frontend:1.536
# latest
